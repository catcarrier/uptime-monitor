...
workers.gatherAllChecks = function () {
    // Get all teh checks in the system
...
workers.validateCheckData = function (originalCheckData) {
    ...
    originalCheckData.userPhone = typeof (originalCheckData.userPhone) == 'string' && originalCheckData.userPhone.length == 20 ? originalCheckData.userPhone : false;
...
workers.processCheckOutcome = function(originalCheckData, checkOutcome) {
    ...
    // The check is up if (1) there is no error, (2) there is a response code, and (3) that code is one of those
    // listed as a success code in this check.
    var state = !checkOutcome.error && checkOutcome.responseCode && originalCheckData.successCodes.indexOf(checkOutcome.responseCode) > -1;
