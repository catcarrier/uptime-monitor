                ...
                _logs.compress(logId, newFileId, function(err){
                    if(!err) {
                        ...
                        _logs.truncate(logId, function(err){
                            if(!err) {
                                console.log('Truncated ' + logId + ' OK.');
                            } else {
                                console.log('Error truncating ' + logId, err);
                            }
                        });
                    } else {
                        console.log('Error compressing ' + logId, err);
                    }
                });
...
workers.init = function () {
    ...
    // Call teh compression loop so logs will be compressed later on
